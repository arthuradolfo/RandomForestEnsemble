...
class Plot(x: DoubleArray, y: DoubleArray, private val title: String = "A bilbo.randomforestensemble.Plot") {

    private val plot = Plot2DPanel()

    constructor(points: MutableList<Pair<Double, Double>>, title: String = "A bilbo.randomforestensemble.Plot"):
